...
public class PlacarView extends GridPane implements Observer{
    ...
    public PlacarView(){
        ...
        vezDoJogador = new Label();

        vezDoJogador.setText("O jogador ativo no momento é: " + Game.getInstance().getJogadorAtivo());
        ...
        this.add(new Label(Game.getInstance().getNomeGremistaJ1() + " - Vida:"),0,0);
        this.add(ptsJ1,1,0);
        this.add(new Label("Mana:"),2,0);
        this.add(manaJ1,3,0);

        this.add(new Label(Game.getInstance().getNomeColoradoJ2() + " - Vida:"),0,1);
        this.add(ptsJ2,1,1);
        this.add(new Label("Mana:"),2,1);
        this.add(manaJ2,3,1);

        this.add(vezDoJogador, 0, 2);
    }
